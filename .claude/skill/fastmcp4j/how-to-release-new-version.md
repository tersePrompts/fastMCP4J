...
language: Java 17+
license: MIT
status: Beta (v0.4.1-beta) — MCP Java SDK 2.0.1, upgraded dependencies, API stable
mcp_spec: 2.0.1
...
annotations:
  ...
  - "@McpFileWrite"
dependency:
  maven: "io.github.terseprompts.fastmcp:fastmcp-java:0.4.1-beta"
  gradle: "implementation 'io.github.terseprompts.fastmcp:fastmcp-java:0.4.1-beta'"
main_class: "io.github.terseprompts.fastmcp.core.FastMCP"
example: |
...
**Example server**: [EchoServer.java](https://github.com/tersePrompts/fastMCP4J/blob/main/src/test/java/io/github/terseprompts/fastmcp/example/EchoServer.java)
