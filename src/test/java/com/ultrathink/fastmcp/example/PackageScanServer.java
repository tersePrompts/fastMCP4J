...
@McpServer(
    ...
    scanBasePackage = "com.ultrathink.fastmcp.example.tools"
)
public class PackageScanServer {

    @McpTool(description = "Get server status")
    public String status() {
        return "Server running with auto-discovered tools from com.ultrathink.fastmcp.example.tools package";
    }
