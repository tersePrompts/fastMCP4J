...
class NotificationTest {
    ...
    void testResourceChangedNotification() {
        ResourceChangedNotification notification = new ResourceChangedNotification("file://test.txt", ResourceChangedNotification.ResourceType.CREATE);
        assertEquals("file://test.txt", notification.getUri());
        Assertions.assertEquals(ResourceChangedNotification.ResourceType.CREATE, notification.getType());
    }
