package io.github.terseprompts.fastmcp.scanner;
...
import io.github.terseprompts.fastmcp.annotations.scanner.ValidationException;
...
class AnnotationScannerTest {
    ...
    void testManualModulesToolNames() {
        ...
        var toolNames = meta.getTools().stream()
            .map(io.github.terseprompts.fastmcp.model.ToolMeta::getName)
            .toList();
    ...
    @McpServer(
        ...
        version = "1.0.0",
        scanBasePackage = "io.github.terseprompts.fastmcp.scanner.testpackage"
    )
